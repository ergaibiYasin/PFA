...
from ecommerce.utilis import unique_slug_generator
...
def upload_image_path(instance, filename):
    ...
    newFilename = random.randint(1,9876543210)
...
class Product(models.Model):
    ...
    price         = models.DecimalField(decimal_places=10, max_digits=19, default=00.00)
