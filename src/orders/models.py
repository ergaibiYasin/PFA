...
from billing.models import BillingProfil
from ecommerce.utilis import unique_order_id_generator
...
class Order(models.Model):
    billing_profile  = models.ForeignKey(BillingProfil, on_delete=models.CASCADE, null=True, blank=True)
